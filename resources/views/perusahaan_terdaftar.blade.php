...
<head>
  ...
  <title>Perusahaan Belum Terdaftar</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="/perusahaan" class="nav-link active">
  ...
  @include('sweet::alert')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Perusahaan belum Terdaftar</h1>
          </div><!-- /.col -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Perusahaan Belum Terdaftar</h3>
              </div>
            </div>
          </div>
          <div class="col-12">
                      ...
                      <div class="card-body table-responsive p-0">
                          <table id="example1" class="table table-bordered table-hover">
                              ...
                              <tr>
                                  ...
                                  <th>Alamat</th>
                                  <th>No Telepon</th>
                                  <th>Estimasi Jumlah Tenaga Kerja</th>
                                  <th>Status</th>
                                  <th>Action</th>
                              </tr>
                              </thead>
                              ...
                              @foreach($perusahaan as $data)
                                  <tr>
                                      ...
                                      @if($data->status == 0)
                                          ...
                                          <td>
                                              <a href="#" class="btn btn-primary verify" data-id="{{$data->perusahaanID}}">Verifikasi</a>
                                              <a href="#" class="btn btn-danger delete" data-id="{{$data->perusahaanID}}">Hapus</a>
                                          </td>
...
<div id="verifyModal" class="modal modal-danger fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="{{url('/perusahaan/verify')}}" method="POST" class="remove-record-model">
                {{ method_field('post') }}
                {{ csrf_field() }}
...
<div id="deleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="{{url('/perusahaan/delete')}}" method="POST" class="remove-record-model">
                {{ method_field('post') }}
                {{ csrf_field() }}
