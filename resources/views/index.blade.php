      ...
      <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{ $countketidaksesuaian }}</h3>

                <p>Jumlah Pengaduan Ketidaksesuaian Data</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="/ketidaksesuaian" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p>Jumlah Pengaduan Akun SIPP</p>
              </div>
              <div class="icon">
