  ...
  @include('sweet::alert')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Reset Akun</h1>
          </div><!-- /.col -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Reset Akun</h3>
              </div>
            </div>
          </div>
          <div class="col-12">
                              ...
                              @foreach($akun as $data)
                                  <tr>
                                      ...
                                      @if($data->status == 0)
                                          ...
                                          <td>
                                              <a href="#" class="btn btn-primary verify" data-id="{{$data->resetID}}">Verifikasi</a>
                                              <a href="#" class="btn btn-danger delete" data-id="{{$data->resetID}}">Hapus</a>
                                          </td>
...
<div id="verifyModal" class="modal modal-danger fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="{{url('/akun/verify')}}" method="POST" class="remove-record-model" enctype="multipart/form-data">
                {{ method_field('post') }}
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <p>Masukkan file yang dibutuhkan untuk verifikasi, lalu tekan tombol verifikasi untuk memverifikasi data.</p>
...
<div id="deleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="{{url('/akun/delete')}}" method="POST" class="remove-record-model">
                {{ method_field('post') }}
                {{ csrf_field() }}
